...
<div id="main_container">
	...
	<div class="header_login" align="center">
        <div class="logo" align="center"><h1>镜平商贸有限公司进销存管理信息系统</h1></div>
    </div>
    <div class="login_form" align="center">
    <form name="myform" action="login.do" method="post">
    <table width="600" border="0" align="center">
     <tr>
       <td align="center" colspan="2"><h1 class="log2">用户登陆</h1></td>
     </tr>
     <tr>
       <td width="200" height="50" align="right" style="font-size:20px"><strong class="log2">用户名:</strong></td>
       <td><input name="account" type="text" size="20" style="font-size:20px"/></td>
     </tr>
     <tr>
       <td height="50" align="right" style="font-size:20px"><strong class="log2">密 &nbsp;&nbsp;&nbsp;码:</strong></td>
