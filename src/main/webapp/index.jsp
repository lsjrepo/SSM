...
<div id="main_container">
    ...
    <div class="main_content">
		...
		<div class="menu">
		<ul>
			<li><a onclick="clickA(this);" alt="order_record_query.jsp" class="bt_blue">订单记录查询</a></li>
			<li><a onclick="clickA(this);" alt="product_storage.jsp" class="bt_blue">产品入库</a></li>
			<li><a onclick="clickA(this);" alt="stockload.do" class="bt_blue">库存查询</a></li>
			<li><a onclick="clickA(this);" alt="sellload.do" class="bt_blue">产品销售</a></li>
			<li><a onclick="clickA(this);" alt="stockwarn.do" class="bt_blue">库存报警</a></li>
			<li><a onclick="clickA(this);" alt="customerquery.do" class="bt_blue">客户管理</a></li>
			<li><a onclick="clickA(this);" alt="modify_password.jsp" class="bt_blue">修改密码</a></li>
		</ul>
		</div> 
    ...
    <div class="footer">
    	...
    	<div class="right_footer">镜平商贸有限公司进销存管理信息系统 | @Sai</div>
    </div>
